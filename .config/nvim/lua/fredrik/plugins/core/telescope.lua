return {

  {
    ...
    config = function(_, opts)
      ...
      -- Set highlights after telescope loads
      vim.api.nvim_set_hl(0, "TelescopeNormal", { bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopePromptNormal", { bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopeResultsNormal", { bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopePreviewNormal", { bg = "#203040" })
      
      vim.api.nvim_set_hl(0, "TelescopeBorder", { fg = "#445566", bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopePromptBorder", { fg = "#203040", bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopeResultsBorder", { fg = "#203040", bg = "#203040" })
      vim.api.nvim_set_hl(0, "TelescopePreviewBorder", { fg = "#203040", bg = "#203040" })
    end,
