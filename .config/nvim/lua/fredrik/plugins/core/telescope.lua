return {

	{
		...
		config = function(_, opts)
			...
			vim.api.nvim_set_hl(0, "TelescopePreviewNormal", { bg = "#181825" })

			vim.api.nvim_set_hl(0, "TelescopeBorder", { fg = "#1e1e2e", bg = "#1e1e2e" })
			vim.api.nvim_set_hl(0, "TelescopePromptBorder", { fg = "#313244", bg = "#313244" })
			vim.api.nvim_set_hl(0, "TelescopeResultsBorder", { fg = "#1e1e2e", bg = "#1e1e2e" })
			vim.api.nvim_set_hl(0, "TelescopePreviewBorder", { fg = "#181825", bg = "#181825" })
		end,
