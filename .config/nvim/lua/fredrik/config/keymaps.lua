...
vim.keymap.set("n", "<M-k>", "<C-w>k", { desc = "Go to upper window", silent = true, noremap = true })
vim.keymap.set("n", "<M-l>", "<C-w>l", { desc = "Go to right window", silent = true, noremap = true })
-- -- Resize windows using <ctrl> arrow keys
-- vim.keymap.set("n", "<M-Up>", ":resize +2<CR>", { desc = "Increase window height", silent = true })
-- vim.keymap.set("n", "<M-Down>", ":resize -2<CR>", { desc = "Decrease window height", silent = true })
-- vim.keymap.set("n", "<M-Right>", ":vertical resize +2<CR>", { desc = "Increase window width", silent = true })
-- vim.keymap.set("n", "<M-Left>", ":vertical resize -2<CR>", { desc = "Decrease window width", silent = true })
-- Move between tmux windows (seems to work fine without these keymaps)

vim.keymap.set("n", "<M-h>", "<cmd>TmuxNavigateLeft<CR>", { desc = "Navigate Left", silent = true })
vim.keymap.set("n", "<M-j>", "<cmd>TmuxNavigateDown<CR>", { desc = "Navigate Down", silent = true })
vim.keymap.set("n", "<M-k>", "<cmd>TmuxNavigateUp<CR>", { desc = "Navigate Up", silent = true })
vim.keymap.set("n", "<M-l>", "<cmd>TmuxNavigateRight<CR>", { desc = "Navigate Right", silent = true })
vim.keymap.set("n", "<M-Left>", "<cmd>TmuxNavigateLeft<CR>", { desc = "Navigate Left", silent = true })
vim.keymap.set("n", "<M-Down>", "<cmd>TmuxNavigateDown<CR>", { desc = "Navigate Down", silent = true })
vim.keymap.set("n", "<M-Up>", "<cmd>TmuxNavigateUp<CR>", { desc = "Navigate Up", silent = true })
vim.keymap.set("n", "<M-Right>", "<cmd>TmuxNavigateRight<CR>", { desc = "Navigate Right", silent = true })
vim.keymap.set("n", "<M-\\>", "<cmd>TmuxNavigatePrevious<CR>", { desc = "Navigate Previous", silent = true })

-- Bufferline go to buffer mappings in Lua
local map = vim.api.nvim_set_keymap
local opts = { noremap = true, silent = true }
for i = 1, 9 do
  map("n", "<leader>" .. i, string.format(':lua require"bufferline".go_to_buffer(%d, true)<CR>', i), opts)
end
map("n", "<leader>0", ':lua require"bufferline".go_to_buffer(10, true)<CR>', opts)

vim.keymap.set("n", "<C-Right>", ":BufferLineCycleNext<CR>", { silent = true })
vim.keymap.set("n", "<C-Left>", ":BufferLineCyclePrev<CR>", { silent = true })
vim.keymap.set("n", "<M-S-Right>", ":BufferLineMoveNext<CR>", { silent = true })
vim.keymap.set("n", "<M-S-Left>", ":BufferLineMovePrev<CR>", { silent = true })
vim.keymap.set("n", "<C-S-Right>", ":tabnext<CR>", { silent = true })
...
function M.setup_commenter_keymaps()
  return {
    {
      mode = { "n" },
      "<C-_>",
...
function M.setup_nvimtree_keymaps()
  return {
    {
      mode = { "n" },
      "<leader>tt",
