...
set -l __fish_yadm_subcommands (echo 'add' ; yadm introspect commands)
...
complete -f -c yadm -n __fish_yadm_needs_command -a add -d 'Add files to be tracked by yadm'

# Options for subcommands
complete -f -c yadm -n "__fish_yadm_using_command add" -s p -d 'Add in patch mode'
